...
export default function AIChatView({
    ...
    pageContent,
    onClose,
    hideAttachments = false, selectedModel,
}: AIChatViewProps) {
    // State
                                ...
                                <>
                                    ...
                                    {message.attachments && message.attachments.length > 0 && (
                                        <div className="ai-chat-attachments">
                                            {message.attachments.map((att: { type?: string; storageId?: string; url?: string; title?: string }, attIndex: number) => (
                                                <div key={attIndex} className="ai-chat-attachment">
                                                    {att.type === "image" && att.storageId && (
                                                        <ImageAttachment storageId={att.storageId as Id<"_storage">} />
                                                    )}

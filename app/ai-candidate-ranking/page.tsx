...
import { ArrowRight, CheckCircle, Trophy, TrendingUp, Award, Star, Target, Zap, Shield, Users } from 'lucide-react'
...
import { AICandidateRankingStructuredData } from './structured-data';

const features = [
    {
        icon: Trophy,
        title: 'Smart Ranking',
        description: 'Automatically rank candidates based on their skills, experience, and fit for the role.'
    },
    {
        icon: Target,
        title: 'Bias-Free Scoring',
        description: 'Our AI evaluates candidates objectively, removing unconscious bias from the hiring process.'
    },
    {
        icon: Zap,
        title: 'Instant Shortlisting',
        description: 'Identify the top 10% of applicants in seconds, saving you hours of manual screening.'
    },
    {
        icon: Star,
        title: 'Quality of Hire',
        description: 'Predict candidate success and retention with our advanced predictive analytics models.'
    }
]

export default function AICandidateRankingPage() {
    return (
        <Box>
            <AICandidateRankingStructuredData />
            {/* Hero Section */}
            <Box
                w="full"
                position="relative"
                    ...
                    >
                        ...
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                >
                                    Hire the Best,
                                    <Text as="span" display="block" bg="#4241ff" bgClip="text">Ignore the Rest</Text>
                                </Heading>
                                <Text
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Stop drowning in resumes. Our AI instantly identifies and ranks your top candidates so you can focus on interviewing the best.
                                </Text>
                            </Box>
                            ...
                            <Flex gap={6} mt={4} fontSize="sm" color="#000" fontWeight="500">
                                <Flex align="center" gap={2}>
                                    ...
                                    <Text>95% Accuracy</Text>
                                </Flex>
                                <Flex align="center" gap={2}>
                                    <Icon as={CheckCircle} color="#4241ff" />
                                    <Text>Bias Elimination</Text>
                                </Flex>
                            </Flex>
                        </VStack>
                        ...
                        <Box position="relative" h={{ base: '400px', md: '500px' }}>
                            <Image
                                src="/ai_candidate_ranking_hero.png"
                    ...
                    <VStack gap={{ base: 12, md: 16 }}>
                        ...
                        <VStack textAlign="center" gap={4} maxW="800px" mx="auto">
                            ...
                            <Heading
                                ...
                                lineHeight="1.2"
                            >
                                Data-Driven <Text as="span" color="#4241ff">Hiring Decisions</Text>
                            </Heading>
                            <Text
                                ...
                                maxW="7xl"
                            >
                                We analyze every data point to ensure you never miss a hidden gem or waste time on unqualified applicants.
                            </Text>
                        </VStack>
                    ...
                    <VStack gap={{ base: 12, md: 20 }}>
                        <VStack textAlign="center" gap={4} maxW="800px" mx="auto">
                            ...
                            <Text fontSize={{ base: 'md', md: 'lg' }} color="#000" opacity={0.8}>
                                Rank candidates in 4 easy steps
                            </Text>
                        </VStack>
                                ...
                                {[
                                    {
                                        ...
                                        description: 'Upload resumes or sync with your ATS instantly.'
                                    },
                                    {
                                        icon: Target,
                                        step: '02',
                                        title: 'Define Criteria',
                                        description: 'Set your ideal skills, experience, and qualifications.'
                                    },
                                    {
                                        icon: Zap,
                                        step: '03',
                                        title: 'AI Scoring',
                                        description: 'Our AI analyzes and scores every profile against your criteria.'
                                    },
                                    {
                                        icon: Trophy,
                                        step: '04',
                                        title: 'Top Talent',
                                        description: 'View your ranked list and start interviewing the best matches.'
                                    }
                                ].map((step, index) => (
                                    <VStack
                                        key={index}
            ...
            <Box py={{ base: 16 }} bg="white">
                <Container maxW="7xl">
                    <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={{ base: 12, lg: 16 }} alignItems="center">
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                <Heading
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Why Use <Text as="span" color="#4241ff">AI Ranking?</Text>
                                </Heading>
                                <Text
                                    fontSize={{ base: 'md', md: 'lg' }}
                                    fontWeight="400"
                                    ...
                                    lineHeight="1.6"
                                >
                                    Efficiency, accuracy, and fairness. Transform your hiring process today.
                                </Text>
                            </Box>
                                ...
                                {[
                                    {
                                        ...
                                        description: 'Reduce time-to-hire by up to 50%.'
                                    },
                                    {
                                        icon: Shield,
                                        title: 'Reduce Bias',
                                        description: 'Ensure fair evaluation for every candidate.'
                                    },
                                    {
                                        icon: Award,
                                        title: 'Better Hires',
                                        description: 'Improve quality of hire and retention rates.'
                                    }
                                ].map((benefit, index) => (
                        ...
                        >
                            <VStack gap={4}>
                                <Icon as={Trophy} boxSize={16} color="#4241ff" opacity={0.5} />
                                <Text color="#4241ff" fontWeight="medium">Top Talent Ranked</Text>
                            </VStack>
                        </Box>
                    </Grid>
                </Container>

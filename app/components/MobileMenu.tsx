        ...
        <>
            ...
            >
                ...
                <div className="mobile-menu-header">
                    <Link href="/" className="mobile-menu-home-link" onClick={onClose}>
                        Home
                    </Link>
                </div>
                            ...
                            <nav className="mobile-menu-toc-links">
                                {sidebarHeadings.map((heading) => (
                                    <button
                                        ...
                                        className={`mobile-menu-toc-link mobile-menu-toc-level-${heading.level} ${sidebarActiveId === heading.id ? "active" : ""
                                            }`}
                                    >

...
import { ArrowRight, CheckCircle, Award, BookOpen, Cpu, Code, Shield, Star, Zap } from 'lucide-react'
...
import { SkillAssessmentsStructuredData } from './structured-data';

const features = [
    {
        icon: Code,
        title: 'Technical Assessments',
        description: 'Prove your coding skills with industry-standard challenges in Python, Java, React, and more.'
    },
    {
        icon: BookOpen,
        title: 'Soft Skills Evaluation',
        description: 'Demonstrate your communication, leadership, and problem-solving abilities.'
    },
    {
        icon: Award,
        title: 'Verified Badges',
        description: 'Earn digital badges that you can display on your profile and LinkedIn to showcase your expertise.'
    },
    {
        icon: Cpu,
        title: 'Adaptive Testing',
        description: 'Our AI-driven tests adapt to your skill level to provide an accurate measurement of your abilities.'
    }
]
...
export default function SkillAssessmentsPage() {
    return (
        <Box>
            <SkillAssessmentsStructuredData />
            {/* Hero Section */}
            <Box
                w="full"
                position="relative"
                ...
                <Container pt={{ base: '36', lg: '40' }} pb={{ base: '12', md: '16' }} maxW="7xl" position="relative">
                    ...
                    >
                        ...
                        <Box position="relative" h={{ base: '400px', md: '500px' }}>
                            <Image
                                src="/skill_assessments_hero.png"
                                ...
                                {[
                                    {
                                        ...
                                        description: 'Choose from our library of over 500 technical and soft skill tests.'
                                    },
                                    {
                                        icon: Code,
                                        step: '02',
                                        title: 'Take the Test',
                                        description: 'Complete the timed assessment in our secure, proctored environment.'
                                    },
                                    {
                                        icon: Zap,
                                        step: '03',
                                        title: 'Get Results',
                                        description: 'Receive instant feedback and a detailed analysis of your performance.'
                                    },
                                    {
                                        icon: Award,
                                        step: '04',
                                        title: 'Earn Badge',
                                        description: 'Get a verified badge to display on your profile and impress recruiters.'
                                    }
                                ].map((step, index) => (
                                    <VStack
                                        key={index}
                    ...
                    <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={{ base: 12, lg: 16 }} alignItems="center">
                                ...
                                {[
                                    {
                                        icon: Star,
                                        title: 'Stand Out',
                                        description: 'Candidates with verified skills get 5x more profile views.'
                                    },
                                    {
                                        icon: Shield,
                                        title: 'Build Trust',
                                        description: 'Prove to employers that you have what it takes to do the job.'
                                    },
                                    {
                                        icon: Zap,
                                        title: 'Fast-Track Hiring',
                                        description: 'Skip initial screening rounds by proving your skills upfront.'
                                    }
                                ].map((benefit, index) => (
                        ...
                        >
                            <VStack gap={4}>
                                ...
                                <Text color="#4241ff" fontWeight="medium">Verified Skills</Text>
                            </VStack>
                        </Box>
                    </Grid>
                </Container>

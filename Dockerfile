...
ENV NEXT_PUBLIC_CONVEX_URL="https://different-aardvark-542.convex.cloud"
ENV NEXT_PUBLIC_CONVEX_SITE_URL="https://different-aardvark-542.convex.site"
ENV CONVEX_DEPLOYMENT="different-aardvark-542"
RUN npm run build

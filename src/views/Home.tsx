...
export default function Home() {
  ...
  // Footer content fetched from Convex (synced via markdown)
  void useQuery(api.pages.getPageBySlug, { slug: "footer" });
  ...
  useEffect(() => {
    ...
    hreflangEnUs.setAttribute("href", homeUrl);
    document.head.appendChild(hreflangEnUs);

    const hreflangDefault = document.createElement("link");
    hreflangDefault.setAttribute("rel", "alternate");
    hreflangDefault.setAttribute("hreflang", "x-default");
    hreflangDefault.setAttribute("href", homeUrl);
    ...
    // Update meta description for home
    if (siteConfig.bio) {
      updateMeta('meta[name="description"]', "content", siteConfig.bio);
      updateMeta('meta[property="og:description"]', "content", siteConfig.bio);
    }

    // Update og:url to match canonical URL
    updateMeta('meta[property="og:url"]', "content", homeUrl);
  }, []);
              ...
              {siteConfig.postsDisplay.homePostsReadMore?.enabled &&
                ...
                posts.length > siteConfig.postsDisplay.homePostsLimit && (
                  <div className="home-posts-read-more">
                    <Link
                      href={siteConfig.postsDisplay.homePostsReadMore.link}

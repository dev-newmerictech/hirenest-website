...
import { ArrowRight, CheckCircle, Zap, Send, Clock, ThumbsUp, Rocket, Target, Mail, Star, Search, Eye } from 'lucide-react'
...
import { FastTrackApplicationsStructuredData } from './structured-data';

const features = [
    {
        icon: Zap,
        title: 'One-Click Apply',
        description: 'Apply to hundreds of jobs instantly with a single click. No more repetitive form filling.'
    },
    {
        icon: Star,
        title: 'Priority Status',
        description: 'Your application gets flagged as "High Priority" to hiring managers, ensuring it gets seen first.'
    },
    {
        icon: Mail,
        title: 'Direct to Hiring Manager',
        description: 'We bypass the general inbox and deliver your application directly to the decision-maker.'
    },
    {
        icon: Target,
        title: 'Application Tracking',
        description: 'Track the status of every application in real-time, from submission to interview.'
    }
]

export default function FastTrackApplicationsPage() {
    return (
        <Box>
            <FastTrackApplicationsStructuredData />
            {/* Hero Section */}
            <Box
                w="full"
                position="relative"
                ...
                <Container pt={{ base: '36', lg: '40' }} pb={{ base: '12', md: '16' }} maxW="7xl" position="relative">
                    ...
                    >
                        ...
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                <Text
                                    ...
                                    maxW="600px"
                                >
                                    Don't let your resume get lost in the pile. Fast-track your applications and get in front of hiring managers instantly.
                                </Text>
                            </Box>
                            ...
                            <Flex gap={6} mt={4} fontSize="sm" color="#000" fontWeight="500">
                                <Flex align="center" gap={2}>
                                    ...
                                    <Text>Priority Review</Text>
                                </Flex>
                                <Flex align="center" gap={2}>
                                    <Icon as={CheckCircle} color="#4241ff" />
                                    <Text>Instant Apply</Text>
                                </Flex>
                            </Flex>
                        </VStack>
                        ...
                        <Box position="relative" h={{ base: '400px', md: '500px' }}>
                            <Image
                                src="/fast_track_applications_hero.png"
                                alt="Fast Track Applications Interface"
                                fill
                    ...
                    <VStack gap={{ base: 12, md: 16 }}>
                        ...
                        <VStack textAlign="center" gap={4} maxW="800px" mx="auto">
                            ...
                            <Heading
                                ...
                                lineHeight="1.2"
                            >
                                Accelerate Your <Text as="span" color="#4241ff">Job Search</Text>
                            </Heading>
                            <Text
                                ...
                                maxW="7xl"
                            >
                                We've streamlined the application process so you can focus on preparing for interviews.
                            </Text>
                        </VStack>
                    ...
                    <VStack gap={{ base: 12, md: 20 }}>
                        <VStack textAlign="center" gap={4} maxW="800px" mx="auto">
                            ...
                            <Text fontSize={{ base: 'md', md: 'lg' }} color="#000" opacity={0.8}>
                                Fast-track your career in 4 easy steps
                            </Text>
                        </VStack>
                            ...
                            <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(4, 1fr)' }} gap={8}>
                                {[
                                    ...
                                    },
                                    {
                                        ...
                                        step: '02',
                                        title: 'One-Click Apply',
                                        description: 'Apply instantly with your stored profile and resume.'
                                    },
                                    {
                                        icon: Rocket,
                                        step: '03',
                                        title: 'Priority Queue',
                                        description: 'Your application jumps to the top of the recruiter\'s list.'
                                    },
                                    {
                                        icon: ThumbsUp,
                                        step: '04',
                                        title: 'Get Interviewed',
                                        description: 'Secure interviews faster with our direct connection to hiring managers.'
                                    }
                                ].map((step, index) => (
                                    <VStack
                                        key={index}
            ...
            <Box py={{ base: 16 }} bg="white">
                <Container maxW="7xl">
                    <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={{ base: 12, lg: 16 }} alignItems="center">
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                <Heading
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Why Use <Text as="span" color="#4241ff">Fast-Track?</Text>
                                </Heading>
                                <Text
                                    fontSize={{ base: 'md', md: 'lg' }}
                                    fontWeight="400"
                                ...
                                {[
                                    {
                                        icon: Clock,
                                        title: 'Save Time',
                                        description: 'Reduce your application time by 90%.'
                                    },
                                    {
                                        icon: Eye,
                                        title: 'Get Noticed',
                                        description: 'Increase your chances of being seen by 3x.'
                                    },
                                    {
                                        icon: Zap,
                                        title: 'Faster Results',
                                        description: 'Get hired in weeks, not months.'
                                    }
                                ].map((benefit, index) => (
                        ...
                        >
                            <VStack gap={4}>
                                <Icon as={Rocket} boxSize={16} color="#4241ff" opacity={0.5} />
                                <Text color="#4241ff" fontWeight="medium">Application Velocity</Text>
                            </VStack>
                        </Box>
                    </Grid>
                </Container>

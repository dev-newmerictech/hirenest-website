...
import { ArrowRight, CheckCircle, Filter, Zap, Clock, ThumbsUp, Layers, Search, UserCheck, FastForward } from 'lucide-react'
...
import { QuickScreeningStructuredData } from './structured-data';

const features = [
    {
        icon: Filter,
        title: 'Automated Filtering',
        description: 'Set your "knockout" questions and let our system automatically disqualify unsuitable candidates.'
    },
    {
        icon: Zap,
        title: 'Instant Feedback',
        description: 'Candidates receive immediate updates on their application status, improving the candidate experience.'
    },
    {
        icon: Layers,
        title: 'Bulk Actions',
        description: 'Screen, advance, or reject multiple candidates at once with our intuitive bulk action tools.'
    },
    {
        icon: UserCheck,
        title: 'Smart Shortlisting',
        description: 'Our AI highlights the most promising candidates based on your specific screening criteria.'
    }
]
                ...
                <Container pt={{ base: '36', lg: '40' }} pb={{ base: '12', md: '16' }} maxW="7xl" position="relative">
                    ...
                    >
                        ...
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                >
                                    ...
                                    <Text as="span" display="block" bg="#4241ff" bgClip="text">Minutes, Not Days</Text>
                                </Heading>
                                <Text
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Accelerate your hiring process with automated screening tools that filter out unqualified candidates instantly.
                                </Text>
                            </Box>
                        ...
                        <Box position="relative" h={{ base: '400px', md: '500px' }}>
                            <Image
                                src="/quick_screening_hero.png"
                                alt="Quick Screening Interface"
                                fill
                    ...
                    <VStack gap={{ base: 12, md: 16 }}>
                        ...
                        <VStack textAlign="center" gap={4} maxW="800px" mx="auto">
                            ...
                            <Heading
                                ...
                                lineHeight="1.2"
                            >
                                Streamline Your <Text as="span" color="#4241ff">Workflow</Text>
                            </Heading>
                            <Text
                                ...
                                maxW="7xl"
                            >
                                Focus your time on the candidates that matter most with our high-speed screening capabilities.
                            </Text>
                        </VStack>
                                ...
                                {[
                                    {
                                        ...
                                        step: '01',
                                        title: 'Set Criteria',
                                        description: 'Define your must-have qualifications and knockout questions.'
                                    },
                                    {
                                        icon: Search,
                                        step: '02',
                                        title: 'Auto-Screen',
                                        description: 'Applications are automatically filtered as they come in.'
                                    },
                                    {
                                        icon: UserCheck,
                                        step: '03',
                                        title: 'Review Matches',
                                        description: 'Focus only on the candidates who meet your requirements.'
                                    },
                                    {
                                        icon: FastForward,
                                        step: '04',
                                        title: 'Fast-Track',
                                        description: 'Instantly move qualified candidates to the interview stage.'
                                    }
                                ].map((step, index) => (
                                    <VStack
                                        key={index}
            ...
            <Box py={{ base: 16 }} bg="white">
                <Container maxW="7xl">
                    <Grid templateColumns={{ base: '1fr', lg: '1fr 1fr' }} gap={{ base: 12, lg: 16 }} alignItems="center">
                        <VStack alignItems="flex-start" gap={6}>
                            <Box>
                                ...
                                <Heading
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Why Use <Text as="span" color="#4241ff">Quick Screening?</Text>
                                </Heading>
                                <Text
                                    fontSize={{ base: 'md', md: 'lg' }}
                                    fontWeight="400"
                                    ...
                                    textAlign={{ base: 'center', lg: 'left' }}
                                >
                                    Don't let great candidates slip away while you're stuck reading resumes.
                                </Text>
                            </Box>
                                ...
                                {[
                                    {
                                        icon: Clock,
                                        title: 'Save Time',
                                        description: 'Cut screening time by 70% with automation.'
                                    },
                                    {
                                        icon: ThumbsUp,
                                        title: 'Better Experience',
                                        description: 'Give candidates faster responses and keep them engaged.'
                                    },
                                    {
                                        icon: Zap,
                                        title: 'Higher Quality',
                                        description: 'Ensure every candidate you interview meets your standards.'
                                    }
                                ].map((benefit, index) => (
                        ...
                        >
                            <VStack gap={4}>
                                <Icon as={Filter} boxSize={16} color="#4241ff" opacity={0.5} />
                                <Text color="#4241ff" fontWeight="medium">Fast & Accurate</Text>
                            </VStack>
                        </Box>
                    </Grid>
                </Container>

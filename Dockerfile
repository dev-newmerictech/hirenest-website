...
ENV NEXT_PUBLIC_CONVEX_URL="https://scrupulous-crane-167.convex.cloud"
ENV NEXT_PUBLIC_CONVEX_SITE_URL="https://scrupulous-crane-167.convex.site"
ENV CONVEX_DEPLOYMENT="scrupulous-crane-167"
RUN npm run build
